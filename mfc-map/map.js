...
const ROUTE_META={
"М1":{title:"ЮАО юг + Бутово восток",order:[5,3,43,7,8,1,2,6,9,13,11],corridor:"Царицыно/Братеево → Зябликово/Орехово → Бирюлёво → Чертаново → Северное/восток Южного Бутово",level:"средняя",far:11,special:"№6 Россошанская, 4 к2 — капремонт."},
"М2":{title:"ТиНАО + Щербинка",order:[16,14,19,18,17,12,15],corridor:"Первомайское → Троицк → Ватутинки → Московский → Коммунарка → запад Южного Бутово → Щербинка",level:"высокая по пробегу, поэтому только 7 объектов",far:16,special:"№16 Первомайское, Центральная, 100 — дом требует ручной проверки координаты."},
...
"М4":{title:"ЦАО",order:[30,39,38,36,34,35,29,37,31,40,32],corridor:"Таганка/Басманный → Красносельский/Мещанский → Тверской → Арбат/Хамовники → Пресня",level:"высокая по парковке и доступу",far:30,special:"№35 Ипатьевский пер., 4-10 стр.1 — спецпропуск, обслуживание на выходных."},
"М5":{title:"Внутренний юг",order:[21,25,44,4,42,45,28,20,33,50,51],corridor:"Академический/Котловка → Нагорный/Нагатино → Москворечье-Сабурово → Даниловский → Якиманка/Замоскворечье",level:"средняя",far:21,special:"Без отдельных ограничений в исходном списке."}
};
const COORDS={
